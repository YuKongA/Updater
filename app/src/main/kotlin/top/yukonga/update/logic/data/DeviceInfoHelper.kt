...
object DeviceInfoHelper {
    ...
    private val deviceList = listOf(
        ...
        Device("Xiaomi 11i / Redmi Note 11 Pro / Note 11 Pro+", "pissarro", "GC"),
        ...
        Device("Redmi K50i / Note 11T Pro / POCO X4 GT", "xaga", "LO"),
        ...
        Device("Redmi A2 / POCO C51", "water", "GO"),
        ...
        Device("Redmi Note 13 / 13R Pro", "gold", "NQ"),
        Device("Redmi Note 13 Pro", "garnet", "NR"),
        Device("Xiaomi 13T", "aristotle", "MF"),
        Device("Xiaomi 14", "houji", "NC"),
        Device("Xiaomi 14 Pro", "shennong", "NB"),
        Device("Redmi 13C / POCO C65", "gale", "GP"),
        Device("Redmi 13R / POCO M6", "air", "GQ"),
