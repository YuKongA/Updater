...
object DeviceInfoHelper {
    ...
    private val devices = listOf(
        ...
        Device("Xiaomi 10T Lite / Redmi Note 9 Pro", "gauguin", "JS", listOf(CN, GL, EEA, TR, TW, IN)),
        ...
        Device("Redmi Note 10 5G / Note 10T / POCO M3 Pro 5G", "camellian", "KS", listOf(GL, ID, RU, TR, EEA, TW)),
        ...
        Device("Redmi Note 10 Pro (India) / Redmi Note 10 Pro Max", "sweetin", "KF", listOf(IN)),
        Device("Xiaomi 10S", "thyme", "GA", listOf(CN)),
        Device("POCO X3 Pro", "vayu", "JU", listOf(GL, EEA, RU, TR, ID, TW)),
        Device("Xiaomi 11 Lite", "courbet", "KQ", listOf(GL, RU, EEA, IN, ID)),
